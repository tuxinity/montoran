        ...
        <div className="space-y-6">
          ...
          <Card className="p-4">
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  `https://wa.me/+6281234567890?text=Halo, saya tertarik dengan ${data.expand?.model.name} tahun ${data.year}`,
                  "_blank"
                )
              }
            >
              WhatsApp
              <svg viewBox="0 0 24 24" className="w-5 h-5 ml-2 fill-current">
